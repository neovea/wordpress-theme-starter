...
class BydMain {
    ...
    public function byd_get_posts($nav = true) {
        ?>
        <div class="row">
    ...
    public function byd_get_page_nav() {
        echo '<div class="navigation">' . posts_nav_link(' - ','page suivante','page pr&eacute;c&eacute;dente') . '</div>';
    }
}